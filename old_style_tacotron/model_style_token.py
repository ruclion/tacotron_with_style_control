...
data_name = 'sr16_aB'
save_path = os.path.join('model', os.path.join(data_name, 'weighting_style_div_200'))
model_name = "TTS"
tfrecord_path = './data/sr16_aB/sr16_aB_wav_mel_stftm.tfrecords'
pkl_path = './data/sr16_aB/sr16_aB_stats.pkl'
...
if __name__ == "__main__":
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        writer = tf.summary.FileWriter(tb_logs_path)
